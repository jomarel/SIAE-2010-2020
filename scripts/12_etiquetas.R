...
write.table(df_etiquetas, 
            file = "h:\\Mi unidad\\Tesis\\Datos con R\\SIAE 2010-2020\\nombres_y_etiquetas.txt", 
            sep = "\t", 
            row.names = FALSE, 
            quote = FALSE, 
            fileEncoding = "UTF-8")
...
write.table(df_depurado, "h:/Mi unidad/Tesis/Datos con R/SIAE 2010-2020/df_depurado.csv", sep = ";", row.names = FALSE)
...
archivo_salida <- "h:\\Mi unidad\\Tesis\\Datos con R\\SIAE 2010-2020\\df_con_etiquetas.csv"
