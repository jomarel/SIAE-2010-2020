...
for (i in 2010:2020) {
  list_df[[i-2009]] <- read.csv(paste0("h:/Mi unidad/Tesis/Datos con R/SIAE 2010-2020/df_", i, ".csv"))
...
#write.csv(df, "df_final.txt", row.names = FALSE)
 save(df_final, file = "h:/Mi unidad/Tesis/Datos con R/SIAE 2010-2020/df_final.RData")
write.table(df_final, "h:/Mi unidad/Tesis/Datos con R/SIAE 2010-2020/df_final.txt", row.names = FALSE, sep = ";", dec = ",")
...
########################################################################################
# load("h:/Mi unidad/Tesis/Datos con R/SIAE 2010-2020/df.RData")
# str(df)
