...
En la misma línea, \citet{rodriguez_sanchez2004} analizan la relación entre especialización y eficiencia técnica en el sistema hospitalario español mediante DEA, mostrando que la especialización en determinadas áreas asistenciales ---medicina intensiva, urgencias, pediatría--- mejora el índice de eficiencia del centro. Su trabajo introduce la heterogeneidad del \textit{output} hospitalario como determinante de la eficiencia, aunque sin distinguir entre dimensiones del \textit{output} ni entre estructuras organizativas, que es precisamente el eje del presente análisis. \citet{martin2007medida} ofrecen una revisión sistemática de los 
métodos de medida de eficiencia en organizaciones sanitarias 
españolas, tanto los indicadores de gestión articulados en cuadros 
de mando como las aproximaciones de frontera, y señalan el 
fraccionamiento y la opacidad de los sistemas de información como 
limitación estructural del análisis empírico en España. En una 
línea más reciente, \citet{martin2019eficiencia} analizan la 
eficiencia técnica de 230 hospitales generales del SNS para el 
período 2010--2012 comparando todas las formas de gestión 
---hospitales integrados, PFI, concesiones administrativas, 
consorcios y hospitales privados--- mediante análisis envolvente 
de datos y modelos multinivel, encontrando una variabilidad 
sustancial entre formas de gestión que justifica el enfoque 
comparado de esta tesis. Ambas limitaciones ---el fraccionamiento 
informativo y la heterogeneidad entre formas de gestión--- son 
precisamente las que la presente investigación afronta mediante 
la explotación sistemática del SIAE para el período 2010--2023 
y el diseño empírico en sistema de dos fronteras.
