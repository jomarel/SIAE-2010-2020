...
Esta tesis ha integrado un enfoque jurídico-institucional con un modelo económico formal y una evaluación empírica rigurosa. El Capítulo~\ref{ch:juridico} ha mostrado que la diversidad organizativa del sistema hospitalario español no es accidental sino habilitada normativamente, y que esa diversidad altera de modo sustantivo las variables que determinan la estructura de incentivos: autonomía del gestor, régimen del personal, mecanismo de financiación y capacidad de supervisión. El modelo teórico ha formalizado esas variables como parámetros de un problema de agencia multitarea, y la estimación empírica ha contrastado las predicciones resultantes con datos de panel del sistema hospitalario español. La coherencia entre los tres niveles de análisis ---institucional, teórico y empírico--- constituye, en sí misma, una contribución de la tesis.
