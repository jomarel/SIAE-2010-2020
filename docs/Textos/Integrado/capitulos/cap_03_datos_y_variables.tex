...
La heterogeneidad institucional descrita en el Capítulo~\ref{ch:juridico} implica que $D^{desc}$ captura un efecto medio de formas organizativas con distinto grado de autonomía real sobre el diseño de los contratos internos del personal: desde concesiones administrativas con plena capacidad de contratación laboral hasta hospitales concertados con dependencia parcial del financiador público. El Diseño~B mitiga parcialmente esta agregación al descomponer el efecto en tres categorías con anclaje económico más preciso (véase Sección~\ref{sec:variables}).
