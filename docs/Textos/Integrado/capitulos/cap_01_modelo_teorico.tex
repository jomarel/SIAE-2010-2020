...
\begin{align}
  ...
  D^D &= \frac{d(1+\sigma_2^2\rho\psi_2+\sigma_1^2\theta(\rho\delta\sigma_2^2+\psi_1))-b\eta\sigma_2^2\psi_{12}}{1+\psi_2\theta\sigma_2^2+\theta\sigma_1^2(\theta\delta\sigma_2^2+\psi_1)} \label{eq:DD}\footnote{La simetría del sistema sugiere que este término debería ser $\sigma_1^2$ en lugar de $\sigma_2^2$. El resultado no afecta a las simulaciones numéricas ni a la estimación empírica, que no utilizan estas expresiones analíticas.}
\end{align}
